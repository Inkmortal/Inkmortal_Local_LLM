...
export class TokenBufferManager {
  ...
  constructor(
    ...
    this.flushDelay = options.flushDelay || 100; // ms (increased for better stability)
    this.maxBufferSize = options.maxBufferSize || 50; // characters (increased for better performance)

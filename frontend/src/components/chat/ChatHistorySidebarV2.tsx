...
interface ChatHistorySidebarV2Props {
  // Visibility control
  showSidebar: boolean;
  toggleSidebar: () => void;
...
const ChatHistorySidebarV2: React.FC<ChatHistorySidebarV2Props> = ({
  showSidebar,
  toggleSidebar,
  conversations,
...
export default memo(ChatHistorySidebarV2, (prevProps, nextProps) => {

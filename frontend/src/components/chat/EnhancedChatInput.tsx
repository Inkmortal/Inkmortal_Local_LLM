...
const EnhancedChatInput: React.FC<EnhancedChatInputProps> = ({ 
  ...
  // State for floating action button visibility
  ...
  return (
    <div className="w-full relative z-50" ref={containerRef}>
      ...
      {showFab && (
        <div className="absolute -top-12 right-4 flex space-x-2 transition-opacity duration-300 opacity-90 hover:opacity-100">
          <button
      ...
      >
        <div
          className={`relative transition-all duration-300 rounded-2xl overflow-hidden ${
            ...
            isFocused ? 'ring-accent-primary' : 'ring-border-color'
          }`}
          style={{

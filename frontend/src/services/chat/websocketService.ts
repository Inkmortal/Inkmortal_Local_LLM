...
export function isWebSocketConnected(): boolean {
  ...
  // Simple debugging without styled logs
  if (isConnected) {
    console.log("WebSocket is connected and ready - streaming will be used");
  } else {
    console.log("WebSocket is NOT connected - will use polling fallback");
  }
